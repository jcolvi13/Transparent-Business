...
Phase5.py : Adds STOCKSKILLS.md (and ETHICSSKILLS.md) to specifically have the agent grab stock data (and ethical data) from specified sources and output a short summary comparing stocks (For Phase 2 MVP progress we are just testing the STOCKSKILLS accuracy and reporting of up to date stock data to the user)
